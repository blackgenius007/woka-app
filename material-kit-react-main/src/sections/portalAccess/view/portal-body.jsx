...
<span
     ...
     <path id="firstLight" d="M317,275.5l-2-2.5l9-9.5l5-2h34.5l1,3.5-9.5,9.5-2,1h-36Z" fill="#3da79a" />
      ...
      <path id="thirdLight" d="M428,275.5l-2-2.5l9-9.5l5-2h34.5l1,3.5-9.5,9.5-2,1h-36Z" fill="#b4b58d" />
                ...
                >
                  <div id="detailsContent" xmlns="http://www.w3.org/1999/xhtml">
                    You are currently {employee.score}% recommendable.Your complain Status is{' '}
                    {employee.complainStatus}. You have spent 2yrs 5months at MC&T.
                  </div>
                </foreignObject>
                <text dx="0" dy="0" font-size="20" letter-spacing="1" id="textContent">
                  70%
                </text>
                <image
