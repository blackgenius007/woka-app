...
const LandingPage = () => {
  ...
  <div className="nav-buttons">
    ...
    <a href="#" className="sign-up btn btn-sm" style={{ color: '#35323e', textDecoration: 'none' }}>Sign Up</a>
      ...
      {/* Features */}
<section className="features" id="features" style={{ marginTop: "100px", backgroundColor: "#eff0f5", overflow: "hidden" }}>
  ...
  <div className="more-features" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "25px", padding: "80px 0 90px 0" }}>
    ...
    <div className="more-features-content">
      <div className="feature" style={{ position: "relative", background: "white", borderRadius: "6px", boxShadow: "0px 5px 15px rgba(0, 0, 0, 0.1)" }}>
        ...
        <div className="feature-details" style={{ padding: "0 25px 30px", marginTop: "60px" }}>
          <h3 style={{ fontSize: "20px", color: "#35323e" }}>Brand Recognition</h3>
          <p style={{ margin: "10px 0 29.41176px", fontSize: "14px", color: "#999" }}>
      ...
      <div className="feature" style={{ position: "relative", background: "white", borderRadius: "6px", boxShadow: "0px 5px 15px rgba(0, 0, 0, 0.1)" }}>
        ...
        <div className="feature-details" style={{ padding: "0 25px 30px", marginTop: "60px" }}>
          <h3 style={{ fontSize: "20px", color: "#35323e" }}>Detailed Records</h3>
          <p style={{ margin: "10px 0 29.41176px", fontSize: "14px", color: "#999" }}>
      ...
      <div className="feature" style={{ position: "relative", background: "white", borderRadius: "6px", boxShadow: "0px 5px 15px rgba(0, 0, 0, 0.1)" }}>
        <div className="feature-illustration" style={{ position: "absolute", top: "-32.5px", left: "25px", display: "grid", placeItems: "center", width: "65px", height: "65px", background: "#3b3054", borderRadius: "50%" }}>
          <img src="https://raw.githubusercontent.com/MohamedAridah/frontendmentor_url_shortening-api/main/images/icon-fully-customizable.svg" alt="Feature Illustration Icon" style={{ maxWidth: "50%" }} />
        </div>
        <div className="feature-details" style={{ padding: "0 25px 30px", marginTop: "60px" }}>
          <h3 style={{ fontSize: "20px", color: "#35323e" }}>Fully Customizable</h3>
          <p style={{ margin: "10px 0 29.41176px", fontSize: "14px", color: "#999" }}>
